...
const copy = completeCopy({
  en: {
    ...
    cards: [
      ...
      ["Swing Cushions", "The cushions for the large swing, together with the chair cushions, are under the stairs in the hallway if they are not already outside. If they are outside, or if you put them outside, please bring them inside if it starts raining."],
  ...
  de: {
    ...
    cards: [
      ...
      ["Schaukelkissen", "Die Kissen fuer die grosse Schaukel sowie die Stuhlkissen befinden sich unter der Treppe im Flur, falls sie nicht bereits draussen liegen. Wenn sie draussen liegen oder Sie sie draussen platzieren, bringen Sie sie bitte hinein, falls es regnet."],
  ...
  fr: {
    ...
    cards: [
      ...
      ["Coussins de balancelle", "Les coussins de la grande balancelle, ainsi que les coussins des chaises, se trouvent sous l'escalier dans le couloir s'ils ne sont pas deja installes dehors. S'ils sont dehors, ou si vous les installez dehors, merci de les rentrer s'il commence a pleuvoir."],
  ...
  cs: {
    ...
    cards: [
      ...
      ["Polstare na houpacku", "Polstare na velkou houpacku spolu s polstari na zidle jsou pod schody na chodbe, pokud uz nejsou venku. Pokud jsou venku, nebo pokud je ven umistite, vezmete je prosim dovnitr, kdyz zacne prset."],
  ...
  pl: {
    ...
    cards: [
      ...
      ["Poduszki na hustawke", "Poduszki do duzej hustawki oraz poduszki na krzesla znajduja sie pod schodami w korytarzu, jesli nie sa juz wystawione na zewnatrz. Jesli sa na zewnatrz albo je tam wyniesiesz, wnies je prosze do srodka, gdy zacznie padac."],
  ...
  es: {
    ...
    cards: [
      ...
      ["Cojines del columpio", "Los cojines del columpio grande, junto con los cojines de las sillas, estan debajo de la escalera en el pasillo si no estan ya colocados fuera. Si estan fuera, o si los colocas fuera, por favor entra los cojines si empieza a llover."],
  ...
  be: {
    ...
    cards: [
      ...
      ["Kussens voor de schommel", "De kussens voor de grote schommel en de stoelkussens liggen onder de trap in de gang als ze nog niet buiten liggen. Als ze buiten liggen, of als u ze buiten legt, breng ze dan naar binnen als het begint te regenen."],
  ...
  nl: {
    ...
    cards: [
      ...
      ["Kussens voor de schommel", "De kussens voor de grote schommel en de stoelkussens liggen onder de trap in de gang als ze nog niet buiten liggen. Als ze buiten liggen, of als je ze buiten legt, breng ze dan naar binnen als het begint te regenen."],
  ...
  sq: {
    ...
    cards: [
      ...
      ["Jasteket e lekundeses", "Jasteket per lekundesen e madhe, bashke me jasteket e karrigeve, jane nen shkallet ne korridor nese nuk jane vendosur jashte. Nese jane jashte, ose nese i vendosni jashte, ju lutemi futini brenda nese fillon te bjere shi."],
  ...
  tr: {
    ...
    cards: [
      ...
      ["Salincak minderleri", "Buyuk salincagin minderleri ve sandalye minderleri, disarida takili degilse koridordaki merdivenin altindadir. Disaridaysa veya siz disari koyarsaniz, yagmur baslarsa lutfen iceri alin."],
  ...
  mk: {
    ...
    cards: [
      ...
      ["Перници за лулашката", "Перниците за големата лулашка, заедно со перничињата за столиците, доколку не се поставени, се наоѓаат под скалата во ходникот. Доколку се поставени или вие ги поставите, и доколку заврне надвор ве молиме да ги внесете внатре."],
